...
const PERIODS = ["Current Month", "Last Month", "Current Quarter", "Last Quarter", "Current Year", "Last Year", "Custom"];
const ACCOUNTS = ["All Accounts", "Cash & Bank", "Receivables", "Payables", "Revenue", "Expenses", "Equity"];
const COST_CENTERS = ["All", "Operations", "Sales", "Marketing", "HR", "IT"];
...
const REPORTS: Report[] = [
  {
    ...
    filters: [
      ...
      { key: "cost_center",label: "Cost Center",   type: "select", options: COST_CENTERS },
    ],
  },
  {
    id: "profit-loss",
  ...
  },
  {
    ...
    filters: [
      { key: "type",      label: "Type",          type: "select", options: ["Receivables", "Payables"] },
