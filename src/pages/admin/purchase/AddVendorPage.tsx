...
/* ── Creatable Select (same pattern as inventory ProductsPage) ── */
...
const CreatableSelect: React.FC<CreatableSelectProps> = ({ label, value, onChange, options, onAddNew, required }) => {
  ...
  const handleAdd = () => {
    ...
    if (trimmed) { onAddNew(trimmed); onChange(trimmed); setNewVal(''); setAdding(false); }
  };
      ...
      {adding ? (
        <div className="flex gap-2">
          ...
          <button type="button" onClick={handleAdd}
            className="h-10 px-3 rounded-lg bg-indigo-600 text-white text-xs font-bold hover:bg-indigo-700 transition">
            Add
          </button>
          <button type="button" onClick={() => setAdding(false)}
            className="h-10 w-10 flex items-center justify-center rounded-lg border border-slate-200 text-slate-400 hover:bg-slate-50 transition">
            <X size={14} />
          </button>
        </div>
      ) : (
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center gap-4 bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
        <button onClick={() => navigate('/admin/purchase/vendors')}
        ...
        <h1 className="text-2xl font-bold tracking-tight text-slate-900">New Vendor</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <SectionHeader icon={<Building2 size={15} className="text-indigo-600" />} title="Company Architecture" color="bg-indigo-50 border-indigo-100" />

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className={labelCls}>Vendor Name <span className="text-rose-400">*</span></label>
                <input className={fieldCls} placeholder="e.g. TechNova Solutions" />
              </div>
              <div>
                <label className={labelCls}>Vendor Name (Abbr)</label>
                <input className={fieldCls} placeholder="e.g. TechNova" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input className={fieldCls} placeholder="@Auto" defaultValue="@Auto" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className={labelCls}>Tax Number / VAT</label>
                <input className={fieldCls} placeholder="TRN12345678" />
              </div>
              <div>
                <label className={labelCls}>Tax Type <span className="text-rose-400">*</span></label>
                <select className={selectCls}>
                  <option value="">Select…</option>
                  <option>GST</option>
                  <option>VAT</option>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="number" min={0} max={100} className={fieldCls} placeholder="0" />
              </div>
              <div>
                <label className={labelCls}>Company</label>
                <input className={fieldCls} placeholder="Company name" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input className={`${fieldCls} pl-8`} placeholder="https://example.com" />
                </div>
              </div>
              <div>
                <label className={labelCls}>GST No</label>
                <input className={fieldCls} placeholder="GST number" />
              </div>
            </div>
          </div>
          ...
          {/* Strategic Contact */}
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <SectionHeader icon={<Phone size={15} className="text-emerald-600" />} title="Strategic Contact" color="bg-emerald-50 border-emerald-100" />

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className={labelCls}>Contact Person <span className="text-rose-400">*</span></label>
                <input className={fieldCls} placeholder="e.g. John Doe" />
              </div>
              <div>
                <label className={labelCls}>Designation</label>
                <input className={fieldCls} placeholder="e.g. Sales Manager" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" className={`${fieldCls} pl-8`} placeholder="john@example.com" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <input className={`${fieldCls} pl-8`} placeholder="+1 234 567 890" />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input className={fieldCls} placeholder="Alternate contact number" />
              </div>
              <div>
                <label className={labelCls}>Address</label>
                <input className={fieldCls} placeholder="Full address" />
              </div>
            </div>
          </div>
          ...
          {/* Logistics Address */}
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <SectionHeader icon={<MapPin size={15} className="text-amber-600" />} title="Logistics Address" color="bg-amber-50 border-amber-100" />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input className={fieldCls} placeholder="State" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input className={fieldCls} placeholder="Postal / Pin code" />
              </div>
              <div>
          ...
          {/* Bank Details */}
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <SectionHeader icon={<Landmark size={15} className="text-blue-600" />} title="Bank Details" color="bg-blue-50 border-blue-100" />

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className={labelCls}>A/c Name</label>
                <input className={fieldCls} placeholder="Account holder name" />
              </div>
              <div>
                <label className={labelCls}>A/c No</label>
                <input className={fieldCls} placeholder="Bank account number" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input className={fieldCls} placeholder="PAN number" />
              </div>
              <div>
                <label className={labelCls}>Bank</label>
                <input className={fieldCls} placeholder="Bank name" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input className={fieldCls} placeholder="Branch name" />
              </div>
              <div>
                <label className={labelCls}>IFSC</label>
                <input className={fieldCls} placeholder="IFSC code" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <CreatableSelect
                  ...
                  onAddNew={v => setVendorTypeOptions(prev => prev.includes(v) ? prev : [...prev, v])}
                />
              </div>
              <div>
                <label className={labelCls}>Partner Type</label>
                <input className={fieldCls} placeholder="Partner type" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input className={fieldCls} placeholder="CR number" />
              </div>
              <div>
                <label className={labelCls}>GST Code</label>
                <input className={fieldCls} placeholder="GST code" />
              </div>
            </div>
          </div>
          ...
          {/* Accounting */}
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <SectionHeader icon={<Settings2 size={15} className="text-violet-600" />} title="Accounting & Compliance" color="bg-violet-50 border-violet-100" />

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className={labelCls}>GL Account <span className="text-rose-400">*</span></label>
                <input className={fieldCls} defaultValue="Accounts Payable" placeholder="GL account" />
              </div>
              <div>
                <label className={labelCls}>Advance Account Mapped To</label>
                <input className={fieldCls} defaultValue="Vendor Advances" placeholder="Advance account" />
              </div>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className={labelCls}>Average Delivery Delay (days)</label>
                <input type="number" min={0} className={fieldCls} placeholder="0" />
              </div>
              <div>
                <label className={labelCls}>Invoice Due Days</label>
                <input type="number" min={0} className={fieldCls} placeholder="30" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input className={fieldCls} placeholder="Reminder note" />
              </div>
            </div>

            <div className="flex items-center gap-6 pt-1">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input type="checkbox" checked={autoGL} onChange={e => setAutoGL(e.target.checked)}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <SectionHeader icon={<CreditCard size={15} className="text-slate-600" />} title="Procurement Dynamics" color="bg-slate-50 border-slate-200" />
            ...
            <div>
              <label className={labelCls}>Pay All Payments From</label>
              <input className={fieldCls} placeholder="Account / bank" />
            </div>
            ...
            <label className="flex items-center gap-2 cursor-pointer select-none pt-1">
              <input type="checkbox" checked={allowCashPay} onChange={e => setAllowCashPay(e.target.checked)}
                className="w-4 h-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-200" />
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <SectionHeader icon={<FileText size={15} className="text-slate-400" />} title="Internal Intelligence" color="bg-slate-50 border-slate-200" />
            <div>
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center gap-2 h-11 rounded-xl bg-[#002147] hover:bg-[#003366] text-white text-sm font-bold transition shadow-lg shadow-blue-900/10">
              <Save size={16} /> Verify & Register Vendor
            </button>
            <button onClick={() => navigate('/admin/purchase/vendors')}
              ...
              <RotateCcw size={16} /> Reset Dynamics
            </button>
          </div>
        </div>
      </div>
