      ...
      render: (value: string) => {
        if (value === 'Sent') return (
          <div className="flex items-center gap-1.5 text-blue-600">
            ...
            <span className="text-[11px] font-bold uppercase tracking-widest">Transmitted</span>
          </div>
        );
        return (
          <div className="flex items-center gap-1.5 text-slate-400">
            <div className="h-1.5 w-1.5 rounded-full bg-slate-300" />
            <span className="text-[11px] font-bold uppercase tracking-widest">Logged</span>
          </div>
        );
      }
    }
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Vendor Debit Ledger</h1>
        </div>
      ...
      <div className="flex items-center gap-2 px-1">
        {['All Debit Notes', 'Transmitted', 'Awaiting Action', 'Overbilling Claims'].map((chip, idx) => (
