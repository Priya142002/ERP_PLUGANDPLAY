      ...
      <div className="bg-[#002147] rounded-2xl md:rounded-[1.5rem] py-3 px-6 md:py-4 md:px-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white/60 font-medium text-[9px] md:text-[10px] uppercase tracking-[0.2em] leading-none mb-1">Corporate Profile</p>
              <div className="flex items-center gap-2">
                <span className="text-white font-bold text-sm">Entity Matrix</span>
                <span className="h-1 w-1 rounded-full bg-white/20" />
                <span className="text-white/90 font-bold text-sm">Global Organizational Data Synchronized</span>
              </div>
            </div>
          </div>
        </div>
